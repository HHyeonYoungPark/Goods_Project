    ...
    <div>
      <form method="post" className="frm" onSubmit={frmHandler}>
        ...
        <input
          type="text"
          className="readAllow"
          onChange={(e) => setReadAllow(e.target.value)}
        />
        <br />
        writeAllow
        <input
          type="text"
          className="writeAllow"
          onChange={(e) => setWriteAllow(e.target.value)}
        />
        <br />
        replyAllow
        <input
          type="text"
          className="replyAllow"
          onChange={(e) => setReplyAllow(e.target.value)}
        />
        <br />
        modifyAllow
        <input
          type="text"
          className="modifyAllow"
          onChange={(e) => setModifyAllow(e.target.value)}
        />
        <br />
        deleteAllow
        <input
          type="text"
          className="deleteAllow"
          onChange={(e) => setDeleteAllow(e.target.value)}
        />
        <br />
        upload
        <input
