    ...
    <div id='app'>
      ...
      <div className='FAQ-wrap'>
          ...
          <ul>
            ...
            <Dropdown visibility={dropdownVisibility1}>
              <p>
                ...
                받은 전용계좌로 입금해야 결제완료 처리됩니다. 영업일 기준 3일이
                되는 시점에 해당 가상계좌는 만료되어 입금할 수 없으며,
                ...
                ​2. 입금하실 은행을 선택해 주세요. (배너가 뜨는 경우 배너를 닫고
                입금할 은행 선택) ​3. 주문 취소/반품 시 환불 받을 방법을 선택해
                주세요. (환불정산액 적립/ 본인계좌 환불 중 선택) ​4. 현금영수증
                신청여부를 선택한 후, 필요 정보를 입력해 주세요. ​5. 주문자 동의
                진행 후 '결제하기'를 누르면 주문이 완료됩니다.
                외부쇼핑몰(네이버페이 가맹점) ​1. 주문서 페이지의 결제수단의
                일반결제 , 나중에 결제 , '나중에 무통장 입금'을 선택해 주세요.
                ​2. 환불정보를 입력해 주세요. 외부쇼핑몰 주문 시 본인 계좌
                환불만 가능합니다. (배너가 뜨는 경우 배너를 닫고 환불정보 입력)
                ​3. 현금영수증 신청여부를 선택한 후, 필요 정보를 입력해 주세요.
                ​4. 구매관련 주문자 동의 항목에 동의해 주세요. ​5. '결제하기'를
                클릭하면 결제페이지가 노출되며, 입금할 은행을 선택하면 주문이
                완료됩니다. ※ 입금 은행 선택 항목이 노출되지 않는 경우 아래와
                같이 노출되는 배너를 닫아주시면, 입금 은행을 선택할 수 있습니다.
              </p>
            </Dropdown>
            <li>
              <span>무통장입금 결제는 어떻게 해야 하나요?</span>
        ...
        <div className='ask-wrap'>
          ...
          <hr className='ask-hr'/>
          <button type='button'><strong>직접 문의하기</strong></button>
        </div>
      </div>
